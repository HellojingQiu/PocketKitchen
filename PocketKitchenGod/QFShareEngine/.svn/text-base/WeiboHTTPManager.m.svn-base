...
-(NSURL*)getSinaOAuthCodeUrl //留给webview用
{
    ...
    QFShareType *shareType = [QFShareEngine getSinaWeiboType];
    if (shareType == nil) return nil;
    
    NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                shareType.appKey, @"client_id", //申请的appkey
                @"token", @"response_type", //access_token
                shareType.redirectUri, @"redirect_uri", //申请时的重定向地址
